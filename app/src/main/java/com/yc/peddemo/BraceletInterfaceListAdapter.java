...
/**
 * Created by ${jc.huang} on 2017/12/11 16:22.
 * Email：jc.huang@ute-tech.com.cn
 */
...
//            Log.d("","periodArray["+i+"]="+periodArray[i]);
//        }
//        for (int i=0;i<resIDArray.length;i++){
//            Log.d("","resIDArray["+i+"]="+resIDArray[i]);
//        }
    }
...
//                    Log.d("BandInterfaceSet","isAbleClick ="+isAbleClick);
//                    if (isAbleClick){
