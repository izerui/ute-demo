...
public class BandInterfaceSetActivity extends AppCompatActivity implements View.OnClickListener, BraceletInterfaceListener, BraceletInterfaceListAdapter.OnItemCheckBoxListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sp = getSharedPreferences(GlobalVariable.SettingSP, Context.MODE_PRIVATE);
        editor = sp.edit();
        ...
        if (mBluetoothLeService != null) {
            ...
            Log.d(TAG, "BandInterfaceSetActivity mBluetoothLeService==null");
        }
...
//                    mWeartherInfoList =
    ...
    public void onBraceletInterface(StringBuilder stringBuilder, byte[] data) {
        ...
        switch (keyValue) {
            case 0xaa:
//                Log.d(TAG,"查询 stringBuilder =" + stringBuilder);
//                data[2] =(byte)0x6d;
//                data[3] =(byte)0x6d;
//                data[4] =(byte)0xde;
//                data[5] =(byte)0xde;
...
//                data[13] =(byte)0x3;
                ...
                Log.d(TAG, "function1HTB =" + function1HTB + ",status1HTB =" + status1HTB);
                Log.d(TAG, "function2HTB =" + function2HTB + ",status2HTB =" + status2HTB);
                ...
                for (int i = 0; i < cycleByteFunction1.length; i++) {
                    Log.d(TAG, "cycleByteFunction1[" + i + "] =" + (cycleByteFunction1[i]));
                ...
                for (int i = 0; i < cycleByteFunction2.length; i++) {
                    Log.d(TAG, "cycleByteFunction2[" + i + "] =" + (cycleByteFunction2[i]));
    ...
    public void onCheckBoxClick(int itemPosition, int whichInterface, boolean isChecked) {
        Log.d(TAG, " itemPosition =" + itemPosition + ",whichInterface =" + whichInterface + ",isChecked =" + isChecked);

        boolean ble_connected21 = sp.getBoolean(
